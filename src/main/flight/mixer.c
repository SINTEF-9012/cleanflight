...
void mixTable(void)
{
    ...
    // SINTEF ICT - JAKOB: Added mode to allow for testing of motors individually with RC remote. Usefull for small prop balancing
    if (rcModeIsActive(BOXMOTORTEST)) {
    	for (i = 0; i < motorCount; i++) {
    ...
    } else if (rcModeIsActive(BOXAIRMODE)) {
