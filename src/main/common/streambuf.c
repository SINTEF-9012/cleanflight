...
// SINTEF JAKOB - Signed representations??
void sbufWriteS8(sbuf_t *dst, int8_t val)
{
	sbufWriteU8(dst, *(uint8_t*)&val);
}
void sbufWriteS16(sbuf_t *dst, int16_t val)
{
	sbufWriteU16(dst, *(uint16_t*)&val);
}
void sbufWriteS32(sbuf_t *dst, int32_t val)
{
	sbufWriteU32(dst, *(uint32_t*)&val);
}


int8_t sbufReadS8(sbuf_t *src)
{
	uint8_t u = sbufReadU8(src);
	return *(int8_t*)&u;
}
int16_t sbufReadS16(sbuf_t *src)
{
	uint16_t u = sbufReadU16(src);
	return *(int16_t*)&u;
}
int32_t sbufReadS32(sbuf_t *src)
{
	uint32_t u = sbufReadU32(src);
	return *(int32_t*)&u;
}
